...
//     const playerGroups5k = buildPlayerGroups(rows5.slice(1));
//     const playerGroups4k = buildPlayerGroups(rows4.slice(1));
...
//         let key = lastClan ? lastClan.toLowerCase() : "unknown";
...
//       console.log("Processing the roles for:", warCategory);
...
//           const highestRole = roles.find(role => player.fameAverage >= role.threshold); // Make sure their role is part of the averages list
...
//             }
//             else {
//               console.log(player.playerName + " doenst have the highest role");
//             }
