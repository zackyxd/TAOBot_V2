...
//   //   timezone: 'America/Phoenix'
//   // });
//   cron.schedule('20 2 * * *', async function () {
//     // cron.schedule('*/5 * * * * *', async function () {
//     // console.log("Cron job running every minute between 2:15 AM and 2:59 AM");
//     // Your code here
//     postAttacks(client);
...
//         if (!grabRaceData) {
//           console.log("No grab attacks data");
//           continue; // If clantag returns nothing, continue
//         }
